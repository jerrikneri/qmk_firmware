...
[_QWERTYWIN] = LAYOUT_preonic_grid(
  ...
  KC_X0   , KC_A   , KC_S   , KC_D   , KC_F    , KC_G  , KC_H   , KC_J    , KC_K   , KC_L   , KC_SCLN, KC_QUOT  ,
  KC_LSFT , KC_Z   , KC_X   , KC_C   , KC_V    , KC_B  , KC_N   , KC_M    , KC_COMM, KC_DOT , KC_SLSH, KC_X4    ,
  FN1     , KC_LCTL, KC_LALT, KC_LGUI, LOWERWIN, KC_SPC, KC_XBS , RAISEWIN, KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT
),
...
[_FN1] = LAYOUT_preonic_grid(
  ...
  _______ , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
  FN1     , FN1    , _______, _______, _______, KC_INS , KC_DEL , _______, KC_MUTE, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_ADJUST] = LAYOUT_preonic_grid(
  ...
  _______, ALT      , KC_SPLT  , _______, FN2    , _______, _______, _______, _______, QWERTYLNX, _______, _______,
